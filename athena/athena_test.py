...
def _qb_pair_row(i: int, device_combo_values: List[str]) -> list:
...
def main():
    ...
    query_builder_tab = [
        ...
        [
            ...
            sg.Input(key="qb_database", size=(32, 1), expand_x=True, pad=((6, 8), 0)),
    ...
    keys_by_device: Dict[str, List[str]] = {}
    qb_next_idx = 1
    qb_indices: List[int] = [0]

    # Startup: load list from DATABASES_LIST_PATH if set
    if DATABASES_LIST_PATH:
        ...
        if databases_list:
            ...
            print("no startup db list found\n  Tried: {}\n  Exists: {}".format(DATABASES_LIST_PATH, os.path.isfile(DATABASES_LIST_PATH)))
    else:
